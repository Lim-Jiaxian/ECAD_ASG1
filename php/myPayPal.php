...
$PayPalApiUsername 	= 'sb-p9wbj34689826_api1.business.example.com'; 		//PayPal API Username
$PayPalApiPassword 	= 'MFTCAAMGV5MZEX5E'; 		//Paypal API password
$PayPalApiSignature = 'AVxojh21GaEm-ayxn.nRWNuiTNRuA.Ttgxsq-chGJXVeK6VyfO4At6RP'; 		//Paypal API Signature
...
$PayPalReturnURL 	= $config->SITE_URL . '/ECAD_ASG1/php/checkoutProcess.php';
//URL to redirect to if user clicks cancel                
$PayPalCancelURL 	= $config->SITE_URL . '/ECAD_ASG1/shoppingCart.php';
