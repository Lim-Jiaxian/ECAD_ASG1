...
if (isset($_SESSION["Cart"])) {
	...
	if ($result->num_rows > 0) {
		...
		// the page header and header row of shopping cart page44
		...
		echo "<th width='250px' style='background-color: #087ca4; color: white;'> Item </th>";
		echo "<th width='90px' style='background-color: #087ca4; color: white;'> Price (S$) </th>";
		echo "<th width='60px' style='background-color: #087ca4; color: white;'> Quantity </th>";
		echo "<th width='120px' style='background-color: #087ca4; color: white;'> Total (S$)</th>";
		echo "<th style='background-color: #087ca4; color: white;'>&nbsp;</th>";
		...
		while ($row = $result->fetch_array()) {
			...
			echo "</form>";
			echo "</td>"; //End of column for update quantity of purchase
			...
			echo "</form>";
			echo "</td>"; //End of column for remove item from shopping cart
			echo "</tr>";
